...
from Rubiks_cube import RubiksCubeEnv
    # ==============================================================================
    # Simulated Annealing with hill climbing for the Rubik's Cube problem  
    # ==============================================================================
class SAAgent:
...
if __name__ == "__main__":
    ...
    env = RubiksCubeEnv(shuffle_steps=20)  # Fewer shuffles for 3x3x3 - it's harder!
    print("Initial Cube State:")
    print(env.display())
    print(f"Initial Heuristic Value: {env.phi}\n")
    
    # Run solver with better parameters for the improved heuristic
    ...
    if solved:
        print(f"Solution found in {len(agent.trajectory)} moves!")
        print("Move sequence:", [move for move, _ in agent.trajectory])